# PCA - Integração - arquivos

Esse repositório possui um exemplo de integração com o sistema PCA utilizando o canal de arquivos.
...
_/src/main/java/br/org/cip/howto_pca_integracao_arquivo/App.java_
...
```
$ mvn clean compile exec:java -Dexec.mainClass="br.org.cip.howto_pca_integracao_arquivo.App"
```
